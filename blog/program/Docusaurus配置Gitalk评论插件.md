...
首先需要 github 账号，创建一个仓库用于存放评论，由于我的博客是同步上传到[github](https://github.com/babiwawa/blog)上，所以就无需新建仓库
...
options 有个选项 repo，填写的是仓库名称，不是链接，像上面我所填写的就是`blog`，而不是填写https://github.com/babiwawa/blog

### 未找到相关的 [Issues](https://github.com/babiwawa/blog/issues) 进行评论，请联系 @xxxxx 初始化创建
...
其中在[第 3 步](#3注册一个-github-applications)的 Authorization callback URL 地址一定要填写成现在博客线上环境 https://babiwawa.github.io ，否则也无法正常使用
...
[查看完整源码点我](https://github.com/babiwawa/blog/blob/main/src/theme/BlogPostPage/index.jsx)
...
[
  {
    ...
    "html_url": "https://github.com/babiwawa/blog/issues/24",
    "id": 1111300101,
    ...
    "user": {
      ...
      "html_url": "https://github.com/babiwawa",
    ...
    "body": "https://babiwawa.github.io/develop/Docusaurus配置Gitalk评论插件\n前言",
    "reactions": {
